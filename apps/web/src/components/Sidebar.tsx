...
export function Sidebar({ isOpen = false, onClose }: SidebarProps) {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    "fixed inset-y-0 left-0 z-40 w-[220px] flex-shrink-0 flex flex-col bg-gray-900 border-r border-gray-800/60 transition-transform duration-300 ease-in-out",
            ...
            >
                ...
                <div className="flex items-center justify-between px-5 py-5 border-b border-gray-800/60">
                    ...
                    <button
                        onClick={onClose}
                        className="lg:hidden p-1.5 rounded-lg text-gray-500 hover:text-gray-200 hover:bg-gray-800/60 transition-colors"
