    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between text-xs">
                ...
                <span className={cn("font-mono font-medium", scoreColor(value))}>
...
export function ScoreBreakdown({
    ...
    return (
        <div className="space-y-3 rounded-xl bg-gray-800/50 border border-gray-700 p-4">
            <div className="flex items-center justify-between">
                <h4 className="text-sm font-semibold text-gray-200">Score Breakdown</h4>
                <span className={cn("text-2xl font-bold tabular-nums", scoreColor(finalScore))}>
            ...
            {explanation && (
                <p className="text-xs text-gray-500 border-t border-gray-700 pt-3">{explanation}</p>
            )}
        </div>
    );
}
